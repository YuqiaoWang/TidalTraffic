...
public class ReconfigStatistic {
    ...
    public ReconfigStatistic(HashMap<String, Area> areaHashMap, SimpleWeightedGraph graph) {
        ...
        /*
        this.loadBalanceHashMap = new HashMap<>();
        this.areaHashMap = areaHashMap;
        Set<String> areaIdSet = areaHashMap.keySet();
    ...
    public void computeLoadBalanceTarget(Area area) {
        ...
        for(SimpleEdge currentEdge : area.edges) {
            double diff = meanEdgeLoad - (double)currentEdge.numberOfOccupatedWavelength / currentEdge.numberOfWavelenth;
