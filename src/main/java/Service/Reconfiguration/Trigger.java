...
/**
 * 重构触发器相关，目前没想好这个与资源分配在代码上怎么结合 Q1写一些静态方法？
 */
public class Trigger {
    ...
    public PredictedIntervalTraffic getPredictedTraffic(NowIntervalTraffic nowIntervalTraffic) {
        ...
        try {
            ...
            PredictedAreaTrafficData wrappedOutput = transClient.client
                    .getPredictedData(Tools.inputDataFormatTrans(nowIntervalTraffic));
    ...
    /*
     * public void run() { //1.要先拿到流量信息，而且是被动拿到的(监听机制)
     * 
