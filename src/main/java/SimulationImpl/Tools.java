...
public class Tools {
    ...
    //用于设定每个area的负载门限
    //门限值候选{0.75，0.6，0.5}
    public static final double DEFAULTTHRESHOLD = 0.6;
    //用于设定每条边的波长数
    public static final int DEFAULTNUMBEROFWAVELENTHES = 60;

    /**业务发生相关*/
    //用于设置生成业务个数
    public static final int DEFAULTSERVICENUMBER = 1000;
    //平均业务到达率
    public static final double DEFAULTLAMBDA = 2;
    //生成业务时，不同时间段产生的业务源宿点概率不同，用来区分时间
    public static final int DEFAULTWORKINGTIME = 1500;
    //业务平均持续时间
    public static final int DEFAULTAVERAGESERVICETIME = 200;
    //单个业务占用最大带宽数
    public static final int DEFAULTMAXNUMBEROFWAVELENGTH = 4;
    //为节约运算时间，调整下方参数可
    public static final int TIMESCALE = 25;
    //初始平滑增大业务达到率的时间
    public static final int PLAINTIME = 200;

    /**流量统计相关*/
    //定时统计的时延
    public static final int COUNT_DELAY = 20;
    //定时统计的周期
    public static final int COUNT_PERIOD = 8;
    ...
    public static double THREASHOLD_LOAD_BALANCE_TARGET = 0.2;  //TODO:全局负载均衡指标门限值
