...
import TrafficDescription.NowEdgeTrafficData;
import TrafficDescription.PredictedEdgeTrafficData;
...
public class TrafficDataService {
  ...
  public interface Iface {
    ...
    public PredictedEdgeTrafficData getEdgePredictedData(NowEdgeTrafficData nowEdgeTrafficData) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getEdgePredictedData(NowEdgeTrafficData nowEdgeTrafficData, org.apache.thrift.async.AsyncMethodCallback<PredictedEdgeTrafficData> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public PredictedEdgeTrafficData recv_getEdgePredictedData() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getEdgePredictedData_call extends org.apache.thrift.async.TAsyncMethodCall<PredictedEdgeTrafficData> {
      private NowEdgeTrafficData nowEdgeTrafficData;
      public getEdgePredictedData_call(NowEdgeTrafficData nowEdgeTrafficData, org.apache.thrift.async.AsyncMethodCallback<PredictedEdgeTrafficData> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public PredictedEdgeTrafficData getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getEdgePredictedData<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getEdgePredictedData_args, PredictedEdgeTrafficData> {
      public getEdgePredictedData() {
        super("getEdgePredictedData");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<PredictedEdgeTrafficData> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<PredictedEdgeTrafficData>() { 
          public void onComplete(PredictedEdgeTrafficData o) {
            getEdgePredictedData_result result = new getEdgePredictedData_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getEdgePredictedData_args args, org.apache.thrift.async.AsyncMethodCallback<PredictedEdgeTrafficData> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class getEdgePredictedData_result implements org.apache.thrift.TBase<getEdgePredictedData_result, getEdgePredictedData_result._Fields>, java.io.Serializable, Cloneable, Comparable<getEdgePredictedData_result>   {
    ...
    public PredictedEdgeTrafficData success; // required
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PredictedEdgeTrafficData.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getEdgePredictedData_result(
      PredictedEdgeTrafficData success)
    {
      this();
      this.success = success;
    }
    ...
    public getEdgePredictedData_result(getEdgePredictedData_result other) {
      if (other.isSetSuccess()) {
        this.success = new PredictedEdgeTrafficData(other.success);
      }
    }
    ...
    public PredictedEdgeTrafficData getSuccess() {
      return this.success;
    }

    public getEdgePredictedData_result setSuccess(PredictedEdgeTrafficData success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((PredictedEdgeTrafficData)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getEdgePredictedData_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new PredictedEdgeTrafficData();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
